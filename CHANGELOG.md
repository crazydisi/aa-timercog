...
Include friendly/neutral timers with Armor/Hull/Final timer types in timer list

## [0.0.6] - 2025-11-20

Fixed time and date issues

## [0.0.5] - 2025-11-14

change the functionality for the timers list function from the current day to the next 24h
